...
- [ ] Connect the frontend to the Express backend using `fetch` or `axios`.

## Definition of Done
- A user can "log in", view their balance, and successfully send money to another user through the UI.
- The UI instantly updates the balance and transaction list after a successful transfer.

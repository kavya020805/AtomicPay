...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to AtomicPay');
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-neutral-500 text-sm mt-1">Join AtomicPay and start transacting</p>
        </div>
        ...
        <div className="bg-neutral-950/80 backdrop-blur-xl border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-neutral-400" htmlFor="reg-username">Username</label>
            ...
            {/* Email */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-neutral-400" htmlFor="reg-email">Email</label>
              <div className="relative">
            ...
            {/* Password */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-neutral-400" htmlFor="reg-password">Password</label>
              <div className="relative">
            ...
            {/* Confirm Password */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-neutral-400" htmlFor="reg-confirm">Confirm Password</label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-600" />
                <input
                  id="reg-confirm"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/20 mt-2"
            >
              {loading ? (
        ...
        <p className="text-center text-[10px] text-neutral-600 mt-4">
          New accounts receive $1,000 demo balance to get started
        </p>
      </div>
    </div>
  );
